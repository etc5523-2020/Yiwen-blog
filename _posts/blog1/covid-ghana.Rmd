...
In Figure \@ref(fig:interactive), readers can explore the data by self with searching or setting certain value of the variable they want. 

It should be explained that "confirmed", "death" and "recovered" respectively represent the number of confirmed, dead and recovered cases in one day. When followed by the suffix "sum", they represent the cumulative number of cases so far. Therefore, we can also observe the total number of cases.
...
datatable(covid_ghana_wider, 
 ...
 "function(settings, json) {",
  ...
  DT::formatStyle(columns = c("death", "confirmed", "recovered", "death_sum", "confirmed_sum", "recovered_sum"), fontSize = '120%') 
