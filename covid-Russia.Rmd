...
datatable(covid_top_rate, 
          escape = FALSE,
          caption = htmltools::tags$caption( style = 'caption-side: top; text-align: center; color:purple; padding-bottom: 20px; font-size:200% ;','Rate of top four areas per 100 thousand people'),
